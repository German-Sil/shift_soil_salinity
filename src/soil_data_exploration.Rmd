...
fit_all <- train(electro_cond_mS_per_cm ~ elevation + ndvi + mari + vssi, 
                 data = soils_extract, 
                 method = "rf", 
                 trControl = trainControl(method = "cv", number = 10), 
                 importance = TRUE)
...
## Without CRSI AND NDVI

```{r}

fit_all <- train(electro_cond_mS_per_cm ~ elevation + mari + vssi, 
                 data = soils_extract, 
                 method = "rf", 
                 trControl = trainControl(method = "cv", number = 10), 
                 importance = TRUE,
...
fit_all <- train(electro_cond_mS_per_cm ~ mari + elevation, 
                 data = soils_extract, 
                 method = "rf", 
                 trControl = trainControl(method = "cv", number = 10), 
                 importance = TRUE,
