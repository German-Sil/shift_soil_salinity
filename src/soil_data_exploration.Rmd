...
fit_all_2 <- randomForest(electro_cond_mS_per_cm ~ elevation + ndvi + mari + vssi + crsi, data = soils_si, importance = T)
```
...
ggsave(filename = "all_plot.png", plot = last_plot(), width = 12, height = 8, device = "png", dpi = 500) #write an image of the plot
