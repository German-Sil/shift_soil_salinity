...
```{r}
frac_1 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_02_24.tif_SMA_20230831T10H58M05S")) %>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_2 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_02_28.tif_SMA_20230831T14H27M47S")) %>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_3 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_08.tif_SMA_20230906T12H54M10S"))%>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_4 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_16.tif_SMA_20231013T13H21M22S"))%>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_5 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_22.tif_SMA_20231107T13H19M50S")) %>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T14h05M20S"))%>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_7 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_12.tif_SMA_20240116T10h38M24S"))%>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_8 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_20.tif_SMA_20240119T16h15M36S"))%>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_all <- c(frac_1, frac_2, frac_3, frac_4, frac_5, frac_6, frac_7, frac_8, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05", "2022_04_12", "2022_04_20")), names = "date") 
```
...
```{r}
upland_frac_1 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_02_24.tif_SMA_20230831T10H58M05S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_2 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_02_28.tif_SMA_20230831T14H27M47S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_3 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_08.tif_SMA_20230906T12H54M10S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_4 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_16.tif_SMA_20231013T13H21M22S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_5 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_22.tif_SMA_20231107T13H19M50S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T14h05M20S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_7 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_12.tif_SMA_20240116T10h38M24S")) %>% 
  filter(band == "UPLANDS_fraction")

upland_frac_8 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_20.tif_SMA_20240119T16h15M36S")) %>% 
  filter(band == "UPLANDS_fraction")

up_frac_all <- c(upland_frac_1, upland_frac_2, upland_frac_3, upland_frac_4, upland_frac_5, upland_frac_6, upland_frac_7, upland_frac_8, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05", "2022_04_12", "2022_04_20")), names = "date") %>% 
  setNames("UPLANDS_fraction")
```

### Pickleweed

```{r}
pick_frac_1 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_02_24.tif_SMA_20230831T10H58M05S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_2 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_02_28.tif_SMA_20230831T14H27M47S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_3 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_08.tif_SMA_20230906T12H54M10S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_4 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_16.tif_SMA_20231013T13H21M22S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_5 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_22.tif_SMA_20231107T13H19M50S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T14h05M20S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_7 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_12.tif_SMA_20240116T10h38M24S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_8 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_20.tif_SMA_20240119T16h15M36S")) %>% 
  filter(band == "PICKLEWEED_fraction")

pick_frac_all <- c(pick_frac_1, pick_frac_2, pick_frac_3, pick_frac_4, pick_frac_5, pick_frac_6, pick_frac_7, pick_frac_8, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05", "2022_04_12", "2022_04_20")), names = "date") %>% 
  setNames("PICKLEWEED_fraction")
```

### Bare Soil

```{r}
soil_frac_1 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_02_24.tif_SMA_20230831T10H58M05S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_2 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_02_28.tif_SMA_20230831T14H27M47S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_3 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_08.tif_SMA_20230906T12H54M10S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_4 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_16.tif_SMA_20231013T13H21M22S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_5 <-read_stars(here("imagery", "fractional_cover", "rfl_2022_03_22.tif_SMA_20231107T13H19M50S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T14h05M20S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_7 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_12.tif_SMA_20240116T10h38M24S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_8 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_20.tif_SMA_20240119T16h15M36S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_all <- c(soil_frac_1, soil_frac_2, soil_frac_3, soil_frac_4, soil_frac_5, soil_frac_6, soil_frac_7, soil_frac_8, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05", "2022_04_12", "2022_04_20")), names = "date") %>% 
  setNames("BARE_SOIL_fraction")
```
...
soils_subset <- soils %>% 
  filter(paired_flight %in% lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05", "2022_04_12", "2022_04_20")))
...
for (i in unique(lubridate::week(soils_subset$paired_flight))){
  ...
  frac_extract <- soil_week %>% 
    st_join(frac_week) %>% 
    select("BARE SOIL_fraction":"UPLANDS_fraction") %>% 
    st_drop_geometry()
  ...
  soils_week <- bind_cols(soil_week, ndvi_extract$ndvi, mari_extract$mari, vssi_extract$vssi, crsi_extract$crsi, frac_extract, pc_extract) %>% 
    rename("ndvi" = "...12",
           ...
           "vssi" = "...14",
           "crsi" = "...15",
           "BARE_SOIL_fraction" = "BARE SOIL_fraction")
...
fit_all_frac <- train(electro_cond_mS_per_cm ~ elevation + mari + vssi  + UPLANDS_fraction + BARE_SOIL_fraction,
...
```{r}
raster_all <- c(crsi_all, ndvi_all, vssi_all, mari_all, mllw_all, pick_frac_all, soil_frac_all, up_frac_all)

all_pred <- predict(raster_all, fit_all_frac, drop_dimensions = F, na.action = na.omit)

write_stars(all_pred, dsn = here("data", "frac_predictions_nc.tif"))
...
ggplot()+
  geom_stars(data = all_pred_feb[,,,8], aes(x = x, y = y, fill = prediction), na.action = na.omit) +
...
Conductivity 
(mS/cm)")+
  ggtitle("April 20, 2022")+#plot title
...
## FIT MODEL FOR TIME FRAME WITHOUT FRACTIONAL COVER
...
```{r}
t.test(x = fit_all$finalModel$predicted, y = fit_all_frac$finalModel$predicted)

effsize::cohen.d(fit_all$finalModel$predicted, fit_all_frac$finalModel$predicted)
```
