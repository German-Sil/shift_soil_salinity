...
frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T12h05M20S"))%>% 
  filter(band %in% c("UPLANDS_fraction", "PICKLEWEED_fraction", "BARE SOIL_fraction")) %>%
  split(3)

frac_all <- c(frac_1, frac_2, frac_3, frac_4, frac_5, frac_6, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05")), names = "date")
```
...
upland_frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T12h05M20S")) %>% 
  filter(band == "UPLANDS_fraction")

up_frac_all <- c(upland_frac_1, upland_frac_2, upland_frac_3, upland_frac_4, upland_frac_5, upland_frac_6, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05")), names = "date")
```
...
pick_frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T12h05M20S")) %>% 
  filter(band == "PICKLEWEED_fraction")


pick_frac_all <- c(pick_frac_1, pick_frac_2, pick_frac_3, pick_frac_4, pick_frac_5, pick_frac_6, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05")), names = "date")
```
...
soil_frac_6 <- read_stars(here("imagery", "fractional_cover", "rfl_2022_04_05.tif_SMA_20231116T12h05M20S")) %>% 
  filter(band == "BARE SOIL_fraction")

soil_frac_all <- c(soil_frac_1, soil_frac_2, soil_frac_3, soil_frac_4, soil_frac_5, soil_frac_6, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05")), names = "date")
```
...
soils_subset <- soils %>% 
  filter(paired_flight %in% lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16", "2022_03_22", "2022_04_05")))
...
fit_all_frac <- train(electro_cond_mS_per_cm ~ elevation + ndvi + mari + vssi + crsi + UPLANDS_fraction + `BARE SOIL_fraction` + PICKLEWEED_fraction,                 data = soils_extract_2, 
                      method = "rf", 
