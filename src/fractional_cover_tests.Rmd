...
ggplot(fit_all_savi_imp_scaled) +
  ...
  geom_point(aes(x = fit_all_savi_imp_scaled$`%IncMSE`, y = variable), color ="#3A5D3D")+ 
  geom_segment(aes(y= variable, x = 0, yend = variable, xend = fit_all_savi_imp_scaled$`%IncMSE`), color = "#3A5D3D", linetype = "dashed")+
