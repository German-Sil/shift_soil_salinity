...
```{r}
up_frac_all <- frac_all %>% 
  select("UPLANDS_fraction")
```
...
fit_all_frac <- train(electro_cond_mS_per_cm ~ elevation + mari + vssi + ndvi + UPLANDS_fraction + BARE_SOIL_fraction + PICKLEWEED_fraction,
