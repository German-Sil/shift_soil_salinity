...
fit_all_frac <- train(electro_cond_mS_per_cm ~ elevation + mari + vssi + ndvi + UPLANDS_fraction + BARE_SOIL_fraction,
...
```{r}
t.test(x = fit_all$finalModel$predicted, y = fit_all_nc$finalModel$predicted)

effsize::cohen.d(fit_all$finalModel$predicted, fit_all_nc$finalModel$predicted)
```
