...
frac_all <- c(frac_1, frac_2, frac_3, frac_4, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16")), names = "date")
```
...
up_frac_all <- c(upland_frac_1, upland_frac_2, upland_frac_3, upland_frac_4, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16")), names = "date")
```
...
pick_frac_all <- c(pick_frac_1, pick_frac_2, pick_frac_3, pick_frac_4, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16")), names = "date")
```
...
soil_frac_all <- c(soil_frac_1, soil_frac_2, soil_frac_3, soil_frac_4, along = 3) %>%
  st_set_dimensions(3, values = lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16")), names = "date")
```
...
soils_subset <- soils %>% 
  filter(paired_flight %in% lubridate::ymd(c("2022_02_24", "2022_02_28", "2022_03_08", "2022_03_16")))
